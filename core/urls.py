...
urlpatterns = [
    ...
    path("how-to/", RedirectView.as_view(url="/", permanent=False), name="how_to_trailing_slash_redirect"),
    path("how-to", RedirectView.as_view(url="/", permanent=False), name="how_to"),
    # api
    path("api/", api.urls),
    path("api/studio/render", agent_image_views.render_studio_image, name="studio_render"),
    # blog
    path("blog/", RedirectView.as_view(url="/", permanent=False), name="blog_posts"),
    path(
        "blog/<slug:slug>/",
        RedirectView.as_view(url="/", permanent=False),
        name="blog_post_trailing_slash_redirect",
    ),
    path("blog/<slug:slug>", RedirectView.as_view(url="/", permanent=False), name="blog_post"),
    # utils
    ...
    path("pricing", RedirectView.as_view(url="/", permanent=False), name="pricing"),
