...
from osig.logging_utils import scrubbing_callback
...
OSIG_RENDER_MAX_ATTEMPTS = env.int("OSIG_RENDER_MAX_ATTEMPTS", default=2)
OSIG_IMAGE_FETCH_TIMEOUT_SECONDS = env.int("OSIG_IMAGE_FETCH_TIMEOUT_SECONDS", default=8)
OSIG_FONT_FETCH_TIMEOUT_SECONDS = env.int("OSIG_FONT_FETCH_TIMEOUT_SECONDS", default=8)
OSIG_FONT_FETCH_MAX_BYTES = env.int("OSIG_FONT_FETCH_MAX_BYTES", default=2_000_000)
OSIG_FONT_CACHE_DIR = env("OSIG_FONT_CACHE_DIR", default="")
OSIG_MCP_URL = env("OSIG_MCP_URL", default="https://osig.app/mcp/")
OSIG_MCP_TRIAL_ENABLED = env.bool("OSIG_MCP_TRIAL_ENABLED", default=True)
OSIG_MCP_REQUIRE_AUTH = env.bool("OSIG_MCP_REQUIRE_AUTH", default=False)
...
SECURE_HSTS_SECONDS = env.int("SECURE_HSTS_SECONDS", default=86400 if ENVIRONMENT == "prod" else 0)
...
if ENVIRONMENT == "prod":
    ...
    LOGGING["loggers"]["osig"]["handlers"].append("json_console")
